function CreateTicket() {
    return ( 
        <div className='container'>
            ...
            <div className='col-4 p-5 mt-2 mb-2'>
                <h4 className='mb-4'><i class="fa fa-user" aria-hidden="true"></i> Your Zerodha Account
                </h4>
            ...
            <div className='col-4 p-5 mt-2 mb-2'>
                <h4 className='mb-4'><i class="fa fa-bar-chart" aria-hidden="true"></i> Your Zerodha Account</h4>
            ...
            <div className='col-4 p-5 mt-2 mb-2'>
                <h4 className='mb-4'><i class="fa fa-credit-card" aria-hidden="true"></i> Account Opening</h4>
            ...
            <div className='col-4 p-5 mt-2 mb-2'>
                <h4 className='mb-4'><i class="fa fa-circle-o-notch" aria-hidden="true"></i> Console</h4>
